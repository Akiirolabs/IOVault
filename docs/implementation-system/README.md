...
|---|---|---|---|
| [IMP-1001](implementations/IMP-1001-write.md) | Write | Workspace and hierarchy implemented; FTR-1001–1004 verified; FTR-1005 partial | `IMP-1001.3` cross-area links plus remaining FTR-1005 scope |
