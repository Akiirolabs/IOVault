...
| 2026-08-13 | [FTR-1013.1.1](../feature-review-system/reviews/FTR-1013-projects-editing-and-table-review.md#findings) / [IMP-1006.1.4](../implementation-system/implementations/IMP-1006-settings.md#numbered-implementation) | Applied the active Theme Mode scrollbar palette to every native scrollable surface while preserving page layouts | DPL-1002 current testing state |
