...
| 2026-08-13 | [FTR-1013](../feature-review-system/reviews/FTR-1013-projects-editing-and-table-review.md) / [IMP-1006.1.4](../implementation-system/implementations/IMP-1006-settings.md#numbered-implementation) | Applied the active Theme Mode scrollbar palette globally and refined project-card drag/menu controls with borderless idle states and theme-aware feedback | DPL-1002 current testing state |
