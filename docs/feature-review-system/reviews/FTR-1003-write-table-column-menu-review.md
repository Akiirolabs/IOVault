...
|---|---|---|---|
| `FTR-1003.1` | Table columns did not provide a complete contextual dropdown menu | Added a `•••` menu to every column header and separated row-specific actions into each row's own contextual menu | ✅ Verified |
| `FTR-1003.1.1` | The table did not provide a contextual Add subrow action | Added `+ Add subrow` to each row menu while retaining the inline plus as a contextual shortcut | ✅ Verified |
| `FTR-1003.1.2` | The column menu did not provide a Rename action | Added inline column rename and row-focus rename actions to their corresponding menus | ✅ Verified |
| `FTR-1003.1.3` | The column menu did not provide a plus control | Added `+ Add column`, which opens the typed-column manager | ✅ Verified |
| `FTR-1003.1.4` | Rows could not be highlighted from a contextual menu | Added persisted cyan, green, yellow, red, and purple row highlights with a clear option | ✅ Verified |
| `FTR-1003.2` | The Add subrow control remained visible outside active interaction | Limited the inline plus to row hover or keyboard focus and kept it visible for touch input | ✅ Verified |
| `FTR-1003.3` | Delete was exposed as a standalone button | Moved confirmed column and row deletion into their corresponding contextual menus | ✅ Verified |
