...
| Status | Complete audit; 2 of 8 corrections verified |
...
| ADT-1002.3 | Planned | Parent lists cannot be collapsed · 2026-07-24 | Add persistent hierarchy collapse controls | — |
| ADT-1002.4 | Planned | Notes need a fuller toolbar · 2026-07-24 | Add the approved note-formatting controls | — |
| ADT-1002.4.1 | Planned | A table column cannot turn each cell into a full page · 2026-07-24 | Add a Page column type whose cells create or open full pages | — |
| ADT-1002.5 | Planned | Notes and tables cannot be dragged between sections · 2026-07-24 | Add accessible drag-and-drop organization with a keyboard alternative | — |
| ADT-1002.6 | Planned | Sections cannot be renamed · 2026-07-24 | Add inline section renaming with persistence | — |
| ADT-1002.7 | Planned | Archived content cannot be reliably recovered · 2026-07-24 | Add visible archive recovery for notes, tables, and descendants | — |
